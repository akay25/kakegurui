<template>
  ...
  >
    ...
    <div class="row container">
      <filp-number :value="score" :speed="500" :digitCount="2" />
    </div>
    <div class="row">
      <div class="xs2">
        <h1 class="display-1 heading-font" style="margin: 10px; width: 100%;">
    ...
    <div class="leave-game-button-holder">
      <va-button icon="clear" class="mr-8" color="danger" @click="leaveGame">
        Leave Game
      </va-button>
    </div>
  </va-sidebar>
...
export default {
  ...
  sockets: {
    ...
    set_player_score: function(playerIndex, score) {
      this.setPlayerScore(playerIndex, score);
    }
  },
  methods: {
    ...mapMutations(["setLoading", "setScore", "setPlayerScore"]),
    leaveRoom() {
